...
function geoError(err){
  ...
  if(!hasFix && retryCount < 2){
    ...
    retryTimer=setTimeout(()=>requestPosition(false),500);
    return;
  }
...
function requestPosition(highAccuracy=true){
  ...
  }, geoError, {enableHighAccuracy:highAccuracy, maximumAge:highAccuracy?15000:60000, timeout:highAccuracy?15000:10000});
}
