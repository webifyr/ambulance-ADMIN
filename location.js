...
const i18n = {
  he:{dir:'rtl',title:'שתף את המיקום שלך עם צוות האמבולנס',sub:'לחץ על הכפתור למטה ואשר גישה למיקום. המיקום יישלח רק לאחר אישורך.',name:'שם',phone:'מספר טלפון',btn:'📍 שיתוף המיקום שלי עכשיו',idle:'🔴 לא ניתן לאתר את המיקום. לחץ שוב וודא ש-GPS פעיל',finding:'🟡 מאתר את המיקום שלך...',ok:'🟢 המיקום שותף בהצלחה וממשיך להתעדכן',denied:'גישה למיקום נחסמה. יש לאפשר Location לאתר בהגדרות הדפדפן ולנסות שוב.',unavailable:'לא הצלחנו לקבל מיקום. הפעל GPS/Location ונסה שוב.',timeout:'איתור המיקום לקח יותר מדי זמן. נסה שוב במקום פתוח.',invalid:'הקישור אינו תקין או שפג תוקפו.',secure:'המיקום משמש רק לצורך איתור הפנייה ומתן השירות.',back:'חזרה לאתר'},
  ar:{dir:'rtl',title:'شارك موقعك مع طاقم الإسعاف',sub:'اضغط الزر بالأسفل واسمح بالوصول للموقع. لن يتم إرسال الموقع إلا بعد موافقتك.',name:'الاسم',phone:'رقم الهاتف',btn:'📍 مشاركة موقعي الآن',idle:'🔴 تعذر تحديد الموقع. اضغط مرة أخرى وتأكد أن GPS يعمل',finding:'🟡 جارٍ تحديد موقعك...',ok:'🟢 تم إرسال الموقع ويستمر تحديثه',denied:'تم رفض إذن الموقع. اسمح للموقع من إعدادات المتصفح ثم حاول مجددًا.',unavailable:'تعذر الحصول على الموقع. فعّل GPS/Location وحاول مجددًا.',timeout:'استغرق تحديد الموقع وقتًا طويلًا. حاول مرة أخرى في مكان مفتوح.',invalid:'الرابط غير صالح أو منتهي.',secure:'يستخدم الموقع فقط للوصول إليك وتقديم الخدمة.',back:'العودة للموقع'},
  en:{dir:'ltr',title:'Share your location with the ambulance team',sub:'Tap the button below and allow location access. Your location is sent only after you approve.',name:'Name',phone:'Phone number',btn:'📍 Share my location now',idle:'🔴 Location unavailable. Tap again and make sure GPS is on',finding:'🟡 Finding your location...',ok:'🟢 Location shared successfully and updating',denied:'Location permission was denied. Allow Location for this site in browser settings and try again.',unavailable:'Could not get your location. Turn on GPS/Location and try again.',timeout:'Location request timed out. Try again in an open area.',invalid:'This link is invalid or expired.',secure:'Your location is used only to reach you and provide the service.',back:'Back to website'}
};
let lang='he';
